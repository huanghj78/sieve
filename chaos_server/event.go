...
func isDesiredUpdate(prevState, curState, desiredPrevStateDiff, desiredCurStateDiff map[string]interface{}, exactMatch bool) bool {
	actualPrevStateDiff, actualCurStateDiff := diffEvent(prevState, curState)
...
func isAnyFieldModified(curState, prevStateDiffToModify map[string]interface{}) bool {
